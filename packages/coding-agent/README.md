...
This BeauPi distribution keeps Pi's extensible runtime and adds bounded in-process sub-agents through `delegate_task`; plan mode and broader workflow orchestration remain extension- or package-defined.
