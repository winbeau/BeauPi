...
// ============================================================================
// OAuth API key resolution from the active application config directory
// ============================================================================
...
/**
 * Resolve API key for a provider from the active application auth.json
 *
...
/**
 * Check if a provider has credentials in the active application auth.json
 */
...
/** Path to the real coding agent config directory */
export const PI_AGENT_DIR = getAgentDir();

/**
 * Get an AuthStorage instance backed by the active application auth.json
