...
Content`,
		...
		it("should auto-discover root markdown skills from the application skill dirs", async () => {
...
Content`,
		...
		it("should resolve project paths relative to the application config directory", async () => {
...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		it("should use the agent dir as baseDir for user application skills", async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it("should dedupe user skill entries when the application skills dir is a symlink to ~/.agents/skills", async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
	...
	describe("ignore files", () => {
		...
		it("should not apply parent .gitignore to application config auto-discovery", async () => {
	...
	describe("command spawning", () => {
		it("should preserve argv entries containing spaces", () => {
			...
			const valueWithSpace = "C:\\Users\\A B\\.beaupi\\npm";
